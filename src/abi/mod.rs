...
use wasmer::{ImportObject, Instance, Store};
...
pub struct AbiConfig {
    pub requestor_command_sender: UnboundedSender<AbiCommand<http::Request<Vec<u8>>>>,
    pub stream_requestor_command_sender: UnboundedSender<AbiCommand<http::Request<Vec<u8>>>>,
